...
* Support Windows PowerShell 5.1 and 7.0 for Windows, and PowerShellCore 7.x for Mac and Linux.
...
## Build status
AppVeyor 5.20 Branch | AppVeyor 5.00 Branch | AppVeyor 4.20 Branch | AppVeyor 4.10 Branch
-------------------- | -------------------- | -------------------- | ---------------------
[![Build status](https://ci.appveyor.com/api/projects/status/yeahhq0y4df1pymb/branch/5.20?svg=true)](https://ci.appveyor.com/project/ChrisLynchHPE/posh-hponeview/branch/5.20)
