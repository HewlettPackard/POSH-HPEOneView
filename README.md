...
* Changing `HPOneView_Classes` class module from targeting DotNet Framework 4.6 to DotNet Standard 2.1.  This will require DotNet Framework 4.7.1 for Windows at a minimum, which means Windows 10 1709 or newer will be required.  It also means that Windows Management Framework 4.0 is no longer supported.
...
AppVeyor 10.00 Branch | AppVeyor 9.10 Branch | AppVeyor 9.00 Branch | AppVeyor 6.60 Branch
-------------------- | -------------------- | -------------------- | --------------------
...
<!-- 10.00 -->
[ov-master-build-status-badge]: https://ci.appveyor.com/api/projects/status/ri3owv0fjkrdnpmk?svg=true
[ov-master-build-link]: https://ci.appveyor.com/project/ChrisLynchHPE/posh-hpeoneview-vy7f4
[ov-master-psgallery-badge]: https://img.shields.io/powershellgallery/dt/HPEOneView.1000.svg?label=PSGallery
[ov-master-psgallery-link]: https://www.powershellgallery.com/packages/HPEOneView.1000

<!-- 9.10 -->
[ov-minus1-build-status-badge]: https://ci.appveyor.com/api/projects/status/kxry606pk5bkw83p?svg=true
[ov-minus1-build-link]: https://ci.appveyor.com/project/ChrisLynchHPE/posh-hpeoneview-mgjh2
[ov-minus1-psgallery-badge]: https://img.shields.io/powershellgallery/dt/HPEOneView.910.svg?label=PSGallery
[ov-minus1-psgallery-link]: https://www.powershellgallery.com/packages/HPEOneView.910

<!-- 9.00 -->
[ov-minus2-build-status-badge]: https://ci.appveyor.com/api/projects/status/6eyc2p6xjdjqblq0?svg=true
[ov-minus2-build-link]: https://ci.appveyor.com/project/ChrisLynchHPE/posh-hpeoneview-de9o0
[ov-minus2-psgallery-badge]: https://img.shields.io/powershellgallery/dt/HPEOneView.900.svg?label=PSGallery
[ov-minus2-psgallery-link]: https://www.powershellgallery.com/packages/HPEOneView.900

<!-- 6.60 -->
[ov-minus3-build-status-badge]: https://ci.appveyor.com/api/projects/status/a52cr3cdav90ff6q?svg=true
[ov-minus3-build-link]: https://ci.appveyor.com/project/ChrisLynchHPE/posh-hpeoneview-j5gwv
[ov-minus3-psgallery-badge]: https://img.shields.io/powershellgallery/dt/HPEOneView.660.svg?label=PSGallery
[ov-minus3-psgallery-link]: https://www.powershellgallery.com/packages/HPEOneView.660
